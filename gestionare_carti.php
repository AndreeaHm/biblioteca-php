...
<body>
    ...
    <table border="1">
        ...
        foreach ($carti as $carte) {
            ...
            echo "<td><a href='modificare_carte.php?id=" . $carte['id_carte'] . "'>Modifică</a> | <a href='sterge_carte.php?id=" . $carte['id_carte'] . "' class='sterge-link' onclick='return confirm(\"Sunteți sigur că doriți să ștergeți această carte?\")'>Șterge</a></td>";
